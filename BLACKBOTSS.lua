...
os.execute('wget https://raw.githubusercontent.com/Kate246/BLACKBOTSS/master/BLACKBOTSS.lua')
os.execute('wget https://raw.githubusercontent.com/Kate246/BLACKBOTSS/master/start.lua')
